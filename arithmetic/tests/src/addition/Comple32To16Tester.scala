...
object Comple32To16Tester extends TestSuite with ChiselUtestTester {
  def tests: Tests = Tests {
    test("complement32_16 should pass") {
      def testcase(width: Int): Unit = {
        ...
        val aInput = "b" +
          getCircuitValue(a1, 16) +
          getCircuitValue(a0, 16)
        val z_expect = "b" +
          getAbsCircuitValue(a1, 16) +
          getAbsCircuitValue(a0, 16)
