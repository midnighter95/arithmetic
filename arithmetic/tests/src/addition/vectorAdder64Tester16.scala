...
object vectorAdder64Tester16 extends TestSuite with ChiselUtestTester {
  def tests: Tests = Tests {
    test("should pass") {
      def testcase(width: Int): Unit = {

        val a:Seq[Int] = Seq(Random.nextInt(65535),Random.nextInt(65535),Random.nextInt(65535),Random.nextInt(65535))
        val b:Seq[Int] = Seq(Random.nextInt(65535),Random.nextInt(65535),Random.nextInt(65535),Random.nextInt(65535))
