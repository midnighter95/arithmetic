...
object Comple32To8Tester extends TestSuite with ChiselUtestTester {
  def tests: Tests = Tests {
    test("complement32_8 should pass") {
      def testcase(width: Int): Unit = {
        ...
        val z_expect = "b" +
          getAbsCircuitValue(a3, 8) +
          getAbsCircuitValue(a2, 8) +
          getAbsCircuitValue(a1, 8) +
          getAbsCircuitValue(a0, 8)
