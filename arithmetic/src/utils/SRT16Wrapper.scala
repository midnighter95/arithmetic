...
//    val noguard = Output(Bool())
//    val guardWidth = Output(UInt(3.W))
//    val needComputerWidth = Output(UInt(7.W))
//    val leftShiftWidthDividend = Output(UInt(8.W))
//    val leftShiftWidthDivisor = Output(UInt(8.W))
//    val zeroHeadDividend = Output(UInt(8.W))
//  })
  ...
  // leftShiftWidthDividend: Int = zeroHeadDividend - (guardwidth)
  ...
  leftShiftWidthDivisor := zeroHeadDivisor
...
//  debug.noguard := noguard
//  debug.guardWidth := guardWidth
//  debug.needComputerWidth := needComputerWidth
//  debug.leftShiftWidthDividend := leftShiftWidthDividend
//  debug.leftShiftWidthDivisor := leftShiftWidthDivisor
//  debug.zeroHeadDividend := zeroHeadDividend
