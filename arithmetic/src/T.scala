...
import addition._
import addition.prefixadder.{PrefixAdder, PrefixAdderForCadence, PrefixAdderWithAssert}
...
class AdderFromJson extends PrefixAdderForCadence(GraphFromJson.prefixGraph.width - 1, GraphFromJson)
